...
:white_check_mark:`pixelCoeff` -  параметр, отображающий количетсво мм в одном пикселе. Для разных комплексов и групп он разный, вычисляется однократно эмпирически при отладке.
...
Для этого смотрим разрешение в настройках камеры или произведем пинг камеры внутри комплекса (Только при условии, что установлен yolov5.service - смотри в конце 4 пункта)
